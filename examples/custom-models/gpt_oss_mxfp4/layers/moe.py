...
class GptOssMoE(MoE, Shardable):
    ...
    def __init__(
        ...
        # If these are in the config, they can be loaded from there instead
        self.alpha = 1.702
        self.limit = 7.0
    ...
    # Lets determine how much of this gets moved into the mojo custom kernel
    # There was some of this code that was blocking in previous intterations
    # Also make sure there is no bf16 specific code here
    ...
    def shard(self, devices: Iterable[DeviceRef]) -> list[GptOssMoE]:
        ...
        if not self._sharding_strategy:
            raise ValueError(
                "MoE module cannot be sharded because no sharding strategy was"
                " provided."
            )
